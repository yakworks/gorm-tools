...
@SuppressWarnings(['NoDef', 'ClosureAsLastMethodParameter'])
class GormUtils {
     ...
     */
    public static <T> T copyDomain(Class<T> domainClass, def old, Map override = [:], boolean ignoreAssociations = true) {
        def copy = domainClass.newInstance()
