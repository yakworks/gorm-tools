...
class MangoSpec extends Specification {
    ...
    //     when:
    //     List list = Org.repo.query([criteria: [isActive: true], max: 150])
    //     then:
    ...
    //     when:
    //     List list = Org.repo.query([criteria: [isActive: [false]], max: 150])
    //     then:
    //     list.size() == 50
    ...
    //     when:
    //     List list = Org.repo.query([criteria: ['testDate.$lte': (new Date() + 1).clearTime()], max: 150])
    //     then:
    ...
    //     when:
    //     List list = Org.repo.query([criteria: ["\$or": [["address.id": 5], ["address.id": 4]]], max: 150])
    //     then:
    //     list.size() == Org.createCriteria().list() {
    //         or {
    //             address {
    ...
    //     when:
    //     List list = Org.repo.query([criteria: [revenue: ["\$gte": 9500.0]], max: 150]).sort { it.id }
    //     then:
    ...
    //     when:
    //     List list = Org.repo.query([criteria: [revenue: ["\$ltef": "credit"]], max: 150]).sort { it.id }
    //     then:
    ...
    //     when:
    //     List list = Org.repo.query([criteria: [revenue: ["\$gtef": "credit"]], max: 150]).sort { it.id }
    //     then:
    ...
    //     when:
    //     List list = Org.repo.query([criteria: [revenue: ["\$gtf": "credit"]], max: 150]).sort { it.id }
    //     then:
    ...
    //     when:
    //     List list = Org.repo.query([criteria: [revenue: ["\$ltf": "credit"]], max: 150]).sort { it.id }
    //     then:
    ...
    //     when:
    //     List list = Org.repo.query([criteria: [credit: ["\$isNull": true]], max: 150]).sort { it.id }
    //     then:
    ...
    //     when:
    //     List list = Org.repo.query([criteria: [credit: "\$isNull"], max: 150]).sort { it.id }
    //     then:
    //     list.size() == Org.createCriteria().list() { isNull "credit" }.size()
    // }
    //
    ...
    //     when:
    //     List list = Org.repo.query([criteria: [credit: null], max: 150]).sort { it.id }
    //     then:
    //     list.size() == Org.createCriteria().list() { isNull "credit" }.size()
    // }
    //
