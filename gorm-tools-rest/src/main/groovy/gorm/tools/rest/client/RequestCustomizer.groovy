 ...
 */
@SuppressWarnings(['ConfusingMethodName']) //method builders are like the vars
@CompileStatic
class RequestCustomizer {
     ...
     * @return this customizer
     */
    RequestCustomizer json(Object object) {
        json(object as JSON)
    }
     ...
     * @return This customizer
     */
    RequestCustomizer xml(Object object) {
        xml(object as XML)
    }
     ...
     * @return This customizer
     */
    RequestCustomizer body(Object content) {
