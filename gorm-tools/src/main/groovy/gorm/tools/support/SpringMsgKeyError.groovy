...
@CompileStatic
class SpringMsgKeyError extends SpringMsgKey {

    String rootCause

    static SpringMsgKeyError of(Exception ex){
        new SpringMsgKeyError().exception(ex)
    }
     ...
     */
    SpringMsgKeyError exception(Exception ex){
        if(!ex) return this
    ...
    SpringMsgKeyError rootCause(Exception ex){
