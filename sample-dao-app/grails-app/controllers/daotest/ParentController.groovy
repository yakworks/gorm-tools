        ...
        if (parentInstance) {
            if (params.version) {
                ...
                if (parentInstance.version > version) {
                    ...
                    parentInstance.errors.rejectValue("version", "default.optimistic.locking.failure", [message(code: 'parent.label', default: 'Parent')] as Object[], "Another user has updated this Parent while you were editing")
