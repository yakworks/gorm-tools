                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="child"><g:message code="parent.child.label" default="Child" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: parentInstance, field: 'child', 'errors')}">
                                    <g:select name="child.id" from="${daotest.Child.list()}" optionKey="id" value="${parentInstance?.child?.id}" noSelection="['null': '']" />
                                </td>
                            </tr>
